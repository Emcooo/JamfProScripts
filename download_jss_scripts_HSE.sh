...
apiUser="emir"					## Set the API Username here if you want it hardcoded
apiPass="95361278Emcooo"				## Set the API Password here if you want it hardcoded
jssURL="https://myhseapple.jamfcloud.com"		## Set the JSS URL here if you want it hardcoded
Token="Authorization: Bearer eyJhbGciOiJIUzI1NiJ9..GikmKoEqdtrWvDqk7TkXSrhrGtOTGeED18i3n96SgJ4"
